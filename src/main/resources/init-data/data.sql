...
insert into calendar_info_table (singer, con_title, con_content, con_time, con_start, con_end, created_date) values ('Men I Trust','MEN I TRUST LIVE IN SEOUL','스탠딩석 99,000원\n지정석 99,000원', "20:00:00","2023-04-22 20:00:00","2023-04-22 21:00:00",now());;

insert into calendar_info_table (singer, con_title, con_content, con_time, con_start, con_end, created_date) values ('NEW HOPE CLUB','NEW HOPE CLUB LIVE IN SEOUL','VIP석 200,000원\n일반석 99,000원', "19:20:00","2023-04-23 19:20:00","2023-04-23 20:50:00",now());;

insert into calendar_info_table (singer, con_title, con_content, con_time, con_start, con_end, created_date) values ('선셋 롤러코스터(Sunset Rollercoaster)','선셋 롤러코스터 내한공연 (Sunset Rollercoaster ＂Infinity Sunset＂ Tour in Seoul)','스탠딩석 88,000원\n지정석 88,000원', "20:00:00","2023-03-29 20:00:00","2023-03-29 21:40:00",now());;

insert into calendar_info_table (singer, con_title, con_content, con_time, con_start, con_end, created_date) values ('Sum 41','Sum 41 Live in Seoul (썸 41 내한공연)','스탠딩석 115,000원\n지정석 115,000원', "20:00:00","2023-03-28 20:00:00","2023-03-28 21:30:00",now());;
...
insert into user_table (user_name, user_email, user_nickname, user_phone, user_birth, user_password, created_at) values ('십칠', '17@gmail.com', '중현17', '010-7777-7777', '1998-01-01', '$2a$10$xcWOSCsY4tsPgkUQ9WNf0OYSNyBZ7TVAPzPjcq9LBcOFuFTEMXy/.', now());;
...
;;
insert into board_table (created_at,board_name) values (now(), '팝송 게시판');
;;
insert into board_table (created_at,board_name) values (now(), '가사 게시판');
;;
...
BEGIN
    ...
    INSERT INTO post_table (created_at,post_content,post_title,board_id,writer_id)
    values(now(), concat('후기내용후기내용후기내용후기내용\n후기내용후기내용후기내용후기내용',i),concat('후기제목후기제목후기제목후기제목\n후기제목후기제목후기제목후기제목',i),3,3);

    INSERT INTO post_table (created_at,post_content,post_title,board_id,writer_id)
    values(now(), concat('후기내용후기내용후기내용후기내용\n후기내용후기내용후기내용후기내용',i),concat('후기제목후기제목후기제목후기제목\n후기제목후기제목후기제목후기제목',i),4,1);
...
;;
insert into comment_table (created_at,comment_content,post_id,writer_id) values (now(), '댓글6댓글6댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5댓글5',3,1);
;;
